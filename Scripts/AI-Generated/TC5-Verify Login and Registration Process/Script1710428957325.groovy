...
"Step 3: Click on link ' Login' -> Navigate to page 'login'"
...
WebUI.verifyElementPresent(findTestObject('AI-Generated/Page_register/hyperlink_contact'), 20, FailureHandling.CONTINUE_ON_FAILURE)

WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/register?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_register/hyperlink_contact'))

"Step 6: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC5-Verify Login and Registration Process_visual_checkpoint')
